...
<link href="css/teacher_registration.css" rel="stylesheet">
</head>
<body>
 <div class="container">
  ...
  <aside class="card-right">
    ...
    <section class="left">
      <div class="brand">
        ...
        <div>
          <h1>Teacher Create your account</h1>
          <p class="lead">Join us — quick signup and secure access.</p>
        </div>
      </div>

      <form id="regForm" action="teacher_action_page.php" method="post" enctype="multipart/form-data">
      ...
      <div class="full">
        ...
        <div class="full">
          ...
          <input id="fullname" name="fullname" type="text" placeholder="Your fullname"  oninput="remove_validation('fnameErr');">
        ...
        <div>
          <label for="age">Age</label>
			    <input id="age" type="text" name="age" oninput="remove_validation('ageErr');">
  ...
  <script>
    ...
    form.addEventListener('submit', (ev)=>{
      ...
      let ok = true;
      if(full_name.length < 2){ nameErr.textContent = 'Please enter your first name.'; ok=false }
      ...
      if(age === ""){ ageErr.textContent = 'Please enter your age.'; ok=false }
